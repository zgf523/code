...
drivermemory=10g
executormemory=20g
SPARK_ARG="--class com.yiwugou.iProbe.dao.user.expe.BaseInfoLogMain4 --master spark://node11:7077 --conf spark.default.parallelism=$parallelism --total-executor-cores $core --driver-memory $drivermemory --executor-memory $executormemory"
